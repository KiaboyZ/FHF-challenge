		...
		<div class="grid grid-cols-5 gap-2">
			...
			<div class="grid col-span-2">
				<div class="row-span-1 flex">
					<button class="text-slate-500 hover:text-slate-700 click:text-slate-900" on:click={() => nodeRef.parentNode.removeChild(nodeRef)}>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
							<path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>
					</button>
					<button class="text-slate-500 hover:text-slate-700 click:text-slate-900">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
